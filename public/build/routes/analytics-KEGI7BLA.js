...
var require_baseIsNative = __commonJS({
  "node_modules/lodash/_baseIsNative.js"(exports, module) {
    ...
    function baseIsNative(value) {
      ...
      var pattern = isFunction19(value) ? reIsNative : reIsHostCtor;
...
var require_isArrayLike = __commonJS({
  "node_modules/lodash/isArrayLike.js"(exports, module) {
    ...
    function isArrayLike(value) {
      return value != null && isLength(value.length) && !isFunction19(value);
    }
  ...
  return _createClass(DefaultLegendContent2, [{
    ...
    value: (
      ...
      function renderIcon(data2) {
        ...
        if (/* @__PURE__ */ import_react6.default.isValidElement(data2.legendIcon)) {
          var iconProps = _objectSpread2({}, data2);
          delete iconProps.legendIcon;
          return /* @__PURE__ */ import_react6.default.cloneElement(data2.legendIcon, iconProps);
        }
...
function _setPrototypeOf7(t, e) {
  return _setPrototypeOf7 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(t2, e3) {
...
function getChildMapping(children, mapFn) {
  ...
  if (children)
    import_react22.Children.map(children, function(c2) {
      return c2;
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props, Component4 = _this$props.component, childFactory2 = _this$props.childFactory, props = _objectWithoutPropertiesLoose11(_this$props, ["component", "childFactory"]);
    ...
    return /* @__PURE__ */ import_react23.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, /* @__PURE__ */ import_react23.default.createElement(Component4, props, children));
  };
...
var AnimateGroupChild = /* @__PURE__ */ function(_Component) {
  ...
  _createClass8(AnimateGroupChild2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ import_react24.default.createElement(Transition_default, _extends13({}, props, {
...
function AnimateGroup(props) {
  ...
  return /* @__PURE__ */ import_react25.default.createElement(TransitionGroup_default, {
    component
  }, import_react25.Children.map(children, function(child, index) {
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  var _useState = (0, import_react26.useState)(-1), _useState2 = _slicedToArray9(_useState, 2), totalLength = _useState2[0], setTotalLength = _useState2[1];
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ import_react26.default.createElement("path", _extends14({}, filterProps(props, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ import_react26.default.createElement(es6_default, {
    ...
    }, /* @__PURE__ */ import_react26.default.createElement("path", _extends14({}, filterProps(props, true), {
      className: layerClass,
...
var Dot = function Dot2(props) {
  ...
  if (cx === +cx && cy === +cy && r === +r) {
    return /* @__PURE__ */ import_react27.default.createElement("circle", _extends15({}, filterProps(props, false), adaptEventHandlers(props), {
      className: layerClass,
      cx,
      cy,
      r
...
var Cross = function Cross2(_ref) {
  ...
  return /* @__PURE__ */ import_react28.default.createElement("path", _extends16({}, filterProps(props, true), {
...
var Trapezoid = function Trapezoid2(props) {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ import_react29.default.createElement("g", null, /* @__PURE__ */ import_react29.default.createElement("path", _extends17({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ import_react29.default.createElement(es6_default, {
    ...
    return /* @__PURE__ */ import_react29.default.createElement(es6_default, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ import_react29.default.createElement("path", _extends17({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
function Shape(_ref2) {
  ...
  var shape;
  if (/* @__PURE__ */ (0, import_react30.isValidElement)(option)) {
    shape = /* @__PURE__ */ (0, import_react30.cloneElement)(option, _objectSpread23(_objectSpread23({}, props), getPropsFromShapeOption(option)));
...
var generatePrefixStyle = function generatePrefixStyle2(name, value) {
  ...
  var result = PREFIX_LIST.reduce(function(res, entry) {
    return _objectSpread24(_objectSpread24({}, res), {}, _defineProperty26({}, entry + camelName, value));
  }, {});
  result[name] = value;
  return result;
};
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  function Brush2(props) {
    var _this;
    _classCallCheck9(this, Brush2);
    _this = _callSuper6(this, Brush2, [props]);
    _defineProperty27(_this, "handleDrag", function(e) {
      if (_this.leaveTimer) {
    ...
    _defineProperty27(_this, "handleTouchMove", function(e) {
      if (e.changedTouches != null && e.changedTouches.length > 0) {
        _this.handleDrag(e.changedTouches[0]);
      }
    });
    _defineProperty27(_this, "handleDragEnd", function() {
      _this.setState({
        isTravellerMoving: false,
        isSlideMoving: false
      }, function() {
    ...
    _defineProperty27(_this, "handleLeaveWrapper", function() {
      if (_this.state.isTravellerMoving || _this.state.isSlideMoving) {
        _this.leaveTimer = window.setTimeout(_this.handleDragEnd, _this.props.leaveTimeOut);
      }
    });
    _defineProperty27(_this, "handleEnterSlideOrTraveller", function() {
      _this.setState({
        isTextActive: true
      });
    });
    _defineProperty27(_this, "handleLeaveSlideOrTraveller", function() {
      _this.setState({
        isTextActive: false
      });
    });
    _defineProperty27(_this, "handleSlideDragStart", function(e) {
  ...
  _inherits8(Brush2, _PureComponent);
  return _createClass9(Brush2, [{
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      if (this.leaveTimer) {
    ...
    value: function handleTravellerMove(e) {
      ...
      this.setState(_defineProperty27(_defineProperty27({}, movingTravellerId, prevValue + delta), "brushMoveStartX", e.pageX), function() {
        if (onChange) {
          if (isFullGap()) {
            onChange(newIndex);
          }
    ...
    value: function handleTravellerMoveKeyboard(direction, id) {
      ...
      this.setState(_defineProperty27({}, id, newScaleValue), function() {
    ...
    value: function renderPanorama() {
      ...
      var chartElement = import_react31.Children.only(children);
      if (!chartElement) {
        return null;
      }
      return /* @__PURE__ */ import_react31.default.cloneElement(chartElement, {
        x: x2,
        y: y2,
        width,
        height,
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ import_react31.default.createElement(Text, _extends18({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ import_react31.default.createElement(Text, _extends18({
        textAnchor: "start",
        verticalAnchor: "middle",
    ...
    value: function render() {
      ...
      var isPanoramic = import_react31.default.Children.count(children) === 1;
    ...
    value: function renderDefaultTraveller(props) {
      ...
      return /* @__PURE__ */ import_react31.default.createElement(import_react31.default.Fragment, null, /* @__PURE__ */ import_react31.default.createElement("rect", {
        x: x2,
        y: y2,
        width,
        height,
...
_defineProperty27(Brush, "displayName", "Brush");
_defineProperty27(Brush, "defaultProps", {
  height: 40,
  travellerWidth: 5,
  gap: 1,
  fill: "#fff",
...
function BarRectangle(props) {
  return /* @__PURE__ */ import_react32.default.createElement(Shape, _extends19({
    shapeType: "rectangle",
...
var minPointSizeCallback = function minPointSizeCallback2(minPointSize) {
  ...
  return function(value, index) {
    ...
    !isValueNumber ? true ? invariant(false, "minPointSize callback function received a value with type of ".concat(_typeof32(value), ". Currently only numbers are supported.")) : invariant(false) : void 0;
    return defaultValue;
  };
};
...
var Bar = /* @__PURE__ */ function(_PureComponent) {
  function Bar2() {
    var _this;
    _classCallCheck10(this, Bar2);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper7(this, Bar2, [].concat(args));
    _defineProperty29(_this, "state", {
      isAnimationFinished: false
    });
    _defineProperty29(_this, "id", uniqueId("recharts-bar-"));
  ...
  _inherits9(Bar2, _PureComponent);
  return _createClass10(Bar2, [{
    ...
    value: function renderRectanglesStatically(data2) {
      ...
      return data2 && data2.map(function(entry, i) {
        ...
        return /* @__PURE__ */ import_react33.default.createElement(Layer, _extends20({
        ...
        }), /* @__PURE__ */ import_react33.default.createElement(BarRectangle, props));
      });
    }
  }, {
    ...
    value: function renderRectanglesWithAnimation() {
      ...
      return /* @__PURE__ */ import_react33.default.createElement(es6_default, {
        ...
        return /* @__PURE__ */ import_react33.default.createElement(Layer, null, _this3.renderRectanglesStatically(stepData));
      });
    }
  }, {
    ...
    value: function renderBackground() {
      ...
      return data2.map(function(entry, i) {
        ...
        return /* @__PURE__ */ import_react33.default.createElement(BarRectangle, _extends20({
    ...
    value: function renderErrorBar(needClip, clipPathId) {
      ...
      return /* @__PURE__ */ import_react33.default.createElement(Layer, errorBarProps, errorBarItems.map(function(item) {
        return /* @__PURE__ */ import_react33.default.cloneElement(item, {
    ...
    value: function render() {
      ...
      }))) : null, /* @__PURE__ */ import_react33.default.createElement(Layer, {
...
_Bar = Bar;
_defineProperty29(Bar, "displayName", "Bar");
_defineProperty29(Bar, "defaultProps", {
  xAxisId: 0,
  yAxisId: 0,
  legendType: "rect",
  minPointSize: 0,
...
_defineProperty29(Bar, "getComposedData", function(_ref2) {
  ...
  var itemDefaultProps = item.type.defaultProps;
  var itemProps = itemDefaultProps !== void 0 ? _objectSpread27(_objectSpread27({}, itemDefaultProps), item.props) : item.props;
...
var formatAxisMap = function formatAxisMap2(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    return _objectSpread28(_objectSpread28({}, result), {}, _defineProperty30({}, id, finalAxis));
  }, {});
};
...
var ScaleHelper = /* @__PURE__ */ function() {
  function ScaleHelper2(scale) {
    _classCallCheck11(this, ScaleHelper2);
    this.scale = scale;
  }
  return _createClass11(ScaleHelper2, [{
    key: "domain",
    get: function get7() {
...
_defineProperty30(ScaleHelper, "EPS", 1e-4);
var createLabeledScales = function createLabeledScales2(options) {
  var scales = Object.keys(options).reduce(function(res, key) {
    return _objectSpread28(_objectSpread28({}, res), {}, _defineProperty30({}, key, ScaleHelper.create(options[key])));
  }, {});
...
var XAxisContext = /* @__PURE__ */ (0, import_react34.createContext)(void 0);
var YAxisContext = /* @__PURE__ */ (0, import_react34.createContext)(void 0);
var ViewBoxContext = /* @__PURE__ */ (0, import_react34.createContext)(void 0);
var OffsetContext = /* @__PURE__ */ (0, import_react34.createContext)({});
var ClipPathIdContext = /* @__PURE__ */ (0, import_react34.createContext)(void 0);
var ChartHeightContext = /* @__PURE__ */ (0, import_react34.createContext)(0);
var ChartWidthContext = /* @__PURE__ */ (0, import_react34.createContext)(0);
var ChartLayoutContextProvider = function ChartLayoutContextProvider2(props) {
  ...
  return /* @__PURE__ */ import_react34.default.createElement(XAxisContext.Provider, {
    value: xAxisMap
  }, /* @__PURE__ */ import_react34.default.createElement(YAxisContext.Provider, {
    value: yAxisMap
  }, /* @__PURE__ */ import_react34.default.createElement(OffsetContext.Provider, {
    value: offset
  }, /* @__PURE__ */ import_react34.default.createElement(ViewBoxContext.Provider, {
    value: viewBox
  }, /* @__PURE__ */ import_react34.default.createElement(ClipPathIdContext.Provider, {
    value: clipPathId
  }, /* @__PURE__ */ import_react34.default.createElement(ChartHeightContext.Provider, {
    value: height
  }, /* @__PURE__ */ import_react34.default.createElement(ChartWidthContext.Provider, {
    value: width
  }, children)))))));
};
var useClipPathId = function useClipPathId2() {
  return (0, import_react34.useContext)(ClipPathIdContext);
};
...
var useXAxisOrThrow = function useXAxisOrThrow2(xAxisId) {
  var xAxisMap = (0, import_react34.useContext)(XAxisContext);
  ...
  !(xAxis != null) ? true ? invariant(false, 'Could not find xAxis by id "'.concat(xAxisId, '" [').concat(_typeof35(xAxisId), "]. ").concat(getKeysForDebug(xAxisMap))) : invariant(false) : void 0;
  return xAxis;
};
...
var useYAxisWithFiniteDomainOrRandom = function useYAxisWithFiniteDomainOrRandom2() {
  var yAxisMap = (0, import_react34.useContext)(YAxisContext);
...
var useYAxisOrThrow = function useYAxisOrThrow2(yAxisId) {
  ...
  !(yAxis != null) ? true ? invariant(false, 'Could not find yAxis by id "'.concat(yAxisId, '" [').concat(_typeof35(yAxisId), "]. ").concat(getKeysForDebug(yAxisMap))) : invariant(false) : void 0;
  return yAxis;
};
var useViewBox = function useViewBox2() {
  var viewBox = (0, import_react34.useContext)(ViewBoxContext);
  return viewBox;
};
var useOffset = function useOffset2() {
  return (0, import_react34.useContext)(OffsetContext);
};
var useChartWidth = function useChartWidth2() {
  return (0, import_react34.useContext)(ChartWidthContext);
};
var useChartHeight = function useChartHeight2() {
  return (0, import_react34.useContext)(ChartHeightContext);
};
...
var renderLine = function renderLine2(option, props) {
  ...
  if (/* @__PURE__ */ import_react35.default.isValidElement(option)) {
    line = /* @__PURE__ */ import_react35.default.cloneElement(option, props);
  } else if ((0, import_isFunction11.default)(option)) {
    line = option(props);
  } else {
    line = /* @__PURE__ */ import_react35.default.createElement("line", _extends21({}, props, {
...
var ReferenceLine = /* @__PURE__ */ function(_React$Component) {
  function ReferenceLine2() {
    _classCallCheck12(this, ReferenceLine2);
    return _callSuper8(this, ReferenceLine2, arguments);
  }
  _inherits10(ReferenceLine2, _React$Component);
  return _createClass12(ReferenceLine2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ import_react35.default.createElement(ReferenceLineImpl, this.props);
    }
  }]);
}(import_react35.default.Component);
_defineProperty31(ReferenceLine, "displayName", "ReferenceLine");
_defineProperty31(ReferenceLine, "defaultProps", {
  isFront: false,
  ifOverflow: "discard",
  xAxisId: 0,
  yAxisId: 0,
...
var ReferenceDot = /* @__PURE__ */ function(_React$Component) {
  function ReferenceDot2() {
    _classCallCheck13(this, ReferenceDot2);
    return _callSuper9(this, ReferenceDot2, arguments);
  }
  _inherits11(ReferenceDot2, _React$Component);
  return _createClass13(ReferenceDot2, [{
    key: "render",
    value: function render() {
...
_defineProperty32(ReferenceDot, "displayName", "ReferenceDot");
_defineProperty32(ReferenceDot, "defaultProps", {
  isFront: false,
  ifOverflow: "discard",
  xAxisId: 0,
  yAxisId: 0,
...
_defineProperty32(ReferenceDot, "renderDot", function(option, props) {
  var dot;
  if (/* @__PURE__ */ import_react36.default.isValidElement(option)) {
    dot = /* @__PURE__ */ import_react36.default.cloneElement(option, props);
  } else if ((0, import_isFunction12.default)(option)) {
    dot = option(props);
  } else {
    dot = /* @__PURE__ */ import_react36.default.createElement(Dot, _extends22({}, props, {
      cx: props.cx,
      cy: props.cy,
...
var ReferenceArea = /* @__PURE__ */ function(_React$Component) {
  function ReferenceArea2() {
    _classCallCheck14(this, ReferenceArea2);
    return _callSuper10(this, ReferenceArea2, arguments);
  }
  _inherits12(ReferenceArea2, _React$Component);
  return _createClass14(ReferenceArea2, [{
    key: "render",
    value: function render() {
      ...
      }, ReferenceArea2.renderRect(shape, _objectSpread31(_objectSpread31({
        clipPath
      }, filterProps(this.props, true)), rect)), Label.renderCallByParent(this.props, rect));
    }
  }]);
}(import_react37.default.Component);
_defineProperty33(ReferenceArea, "displayName", "ReferenceArea");
_defineProperty33(ReferenceArea, "defaultProps", {
  isFront: false,
  ifOverflow: "discard",
  xAxisId: 0,
  yAxisId: 0,
...
_defineProperty33(ReferenceArea, "renderRect", function(option, props) {
  var rect;
  if (/* @__PURE__ */ import_react37.default.isValidElement(option)) {
    rect = /* @__PURE__ */ import_react37.default.cloneElement(option, props);
  } else if ((0, import_isFunction13.default)(option)) {
    rect = option(props);
  } else {
    rect = /* @__PURE__ */ import_react37.default.createElement(Rectangle, _extends23({}, props, {
...
var CartesianAxis = /* @__PURE__ */ function(_Component) {
  function CartesianAxis2(props) {
    var _this;
    _classCallCheck15(this, CartesianAxis2);
  ...
  return _createClass15(CartesianAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ import_react38.default.createElement("line", _extends24({}, props, {
    ...
    value: (
      ...
      function renderTicks(ticks2, fontSize, letterSpacing) {
        ...
        var items = finalTicks.map(function(entry, i) {
          ...
          return /* @__PURE__ */ import_react38.default.createElement(Layer, _extends24({
            className: "recharts-cartesian-axis-tick",
            key: "tick-".concat(entry.value, "-").concat(entry.coordinate, "-").concat(entry.tickCoord)
          }, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /* @__PURE__ */ import_react38.default.createElement("line", _extends24({}, tickLineProps, lineCoord, {
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ import_react38.default.isValidElement(option)) {
        tickItem = /* @__PURE__ */ import_react38.default.cloneElement(option, props);
      } else if ((0, import_isFunction15.default)(option)) {
        tickItem = option(props);
      } else {
        tickItem = /* @__PURE__ */ import_react38.default.createElement(Text, _extends24({}, props, {
...
_defineProperty35(CartesianAxis, "displayName", "CartesianAxis");
_defineProperty35(CartesianAxis, "defaultProps", {
  x: 0,
  y: 0,
  width: 0,
  height: 0,
...
var _excluded18 = ["x1", "y1", "x2", "y2", "key"];
...
function renderLineItem(option, props) {
  ...
  if (/* @__PURE__ */ import_react39.default.isValidElement(option)) {
    lineItem = /* @__PURE__ */ import_react39.default.cloneElement(option, props);
  } else if ((0, import_isFunction16.default)(option)) {
    lineItem = option(props);
  } else {
    var x1 = props.x1, y1 = props.y1, x2 = props.x2, y2 = props.y2, key = props.key, others = _objectWithoutProperties17(props, _excluded18);
    ...
    lineItem = /* @__PURE__ */ import_react39.default.createElement("line", _extends25({}, restOfFilteredProps, {
      x1,
      y1,
      x2,
      y2,
...
function CartesianGrid(props) {
  ...
  if ((!horizontalPoints || !horizontalPoints.length) && (0, import_isFunction16.default)(horizontalCoordinatesGenerator)) {
    ...
    warn(Array.isArray(generatorResult), "horizontalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof41(generatorResult), "]"));
  ...
  if ((!verticalPoints || !verticalPoints.length) && (0, import_isFunction16.default)(verticalCoordinatesGenerator)) {
    ...
    warn(Array.isArray(_generatorResult), "verticalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof41(_generatorResult), "]"));
  ...
  }, /* @__PURE__ */ import_react39.default.createElement(Background, {
  ...
  }), /* @__PURE__ */ import_react39.default.createElement(HorizontalGridLines, _extends25({}, propsIncludingDefaults, {
    offset,
    horizontalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ import_react39.default.createElement(VerticalGridLines, _extends25({}, propsIncludingDefaults, {
    offset,
    verticalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ import_react39.default.createElement(HorizontalStripes, _extends25({}, propsIncludingDefaults, {
    horizontalPoints
  })), /* @__PURE__ */ import_react39.default.createElement(VerticalStripes, _extends25({}, propsIncludingDefaults, {
    verticalPoints
  })));
}
...
var _excluded19 = ["type", "layout", "connectNulls", "ref"];
var _excluded26 = ["key"];
...
var Line = /* @__PURE__ */ function(_PureComponent) {
  function Line2() {
    ...
    _defineProperty37(_this, "generateSimpleStrokeDasharray", function(totalLength, length) {
      return "".concat(length, "px ").concat(totalLength - length, "px");
    });
    _defineProperty37(_this, "getStrokeDasharray", function(length, totalLength, lines) {
    ...
    _defineProperty37(_this, "id", uniqueId("recharts-line-"));
    _defineProperty37(_this, "pathRef", function(node) {
  ...
  _inherits14(Line2, _PureComponent);
  return _createClass16(Line2, [{
    key: "componentDidMount",
    value: function componentDidMount() {
    ...
    value: function renderErrorBar(needClip, clipPathId) {
      ...
      return /* @__PURE__ */ import_react40.default.createElement(Layer, errorBarProps, errorBarItems.map(function(item) {
        return /* @__PURE__ */ import_react40.default.cloneElement(item, {
    ...
    value: function renderDots(needClip, clipDot, clipPathId) {
      ...
      return /* @__PURE__ */ import_react40.default.createElement(Layer, _extends26({
    ...
    value: function renderCurveStatically(points, needClip, clipPathId, props) {
      var _this$props3 = this.props, type = _this$props3.type, layout = _this$props3.layout, connectNulls = _this$props3.connectNulls, ref = _this$props3.ref, others = _objectWithoutProperties18(_this$props3, _excluded19);
      ...
      return /* @__PURE__ */ import_react40.default.createElement(Curve, _extends26({}, curveProps, {
    ...
    value: function renderCurveWithAnimation(needClip, clipPathId) {
      ...
      return /* @__PURE__ */ import_react40.default.createElement(es6_default, {
        begin: animationBegin,
        duration: animationDuration,
        isActive: isAnimationActive,
        easing: animationEasing,
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ import_react40.default.createElement(Layer, {
        className: layerClass
      }, needClipX || needClipY ? /* @__PURE__ */ import_react40.default.createElement("defs", null, /* @__PURE__ */ import_react40.default.createElement("clipPath", {
        id: "clipPath-".concat(clipPathId)
        ...
        width: needClipX ? width : width * 2,
        height: needClipY ? height : height * 2
      })), !clipDot && /* @__PURE__ */ import_react40.default.createElement("clipPath", {
    ...
    value: function renderDotItem(option, props) {
      ...
      if (/* @__PURE__ */ import_react40.default.isValidElement(option)) {
        dotItem = /* @__PURE__ */ import_react40.default.cloneElement(option, props);
      } else if ((0, import_isFunction17.default)(option)) {
        dotItem = option(props);
      } else {
        var key = props.key, dotProps = _objectWithoutProperties18(props, _excluded26);
        var className = clsx_default("recharts-line-dot", typeof option !== "boolean" ? option.className : "");
        dotItem = /* @__PURE__ */ import_react40.default.createElement(Dot, _extends26({
          key
        }, dotProps, {
          className
        }));
...
_defineProperty37(Line, "displayName", "Line");
_defineProperty37(Line, "defaultProps", {
  xAxisId: 0,
  yAxisId: 0,
  connectNulls: false,
  activeDot: true,
...
_defineProperty37(Line, "getComposedData", function(_ref4) {
...
function XAxisImpl(_ref) {
  ...
  return (
    ...
    /* @__PURE__ */ import_react41.default.createElement(CartesianAxis, _extends27({}, axisOptions, {
...
var XAxis = /* @__PURE__ */ function(_React$Component) {
  ...
  return _createClass17(XAxis2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ import_react41.default.createElement(XAxisImpl, this.props);
    }
  }]);
...
var YAxisImpl = function YAxisImpl2(_ref) {
  ...
  return (
    // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
    /* @__PURE__ */ import_react42.default.createElement(CartesianAxis, _extends28({}, axisOptions, {
      className: clsx_default("recharts-".concat(axisOptions.axisType, " ").concat(axisOptions.axisType), axisOptions.className),
      viewBox: {
        x: 0,
        y: 0,
...
var YAxis = /* @__PURE__ */ function(_React$Component) {
  ...
  return _createClass18(YAxis2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ import_react42.default.createElement(YAxisImpl, this.props);
    }
  }]);
...
var _excluded27 = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
...
var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
  var chartName = _ref6.chartName, GraphicalChild = _ref6.GraphicalChild, _ref6$defaultTooltipE = _ref6.defaultTooltipEventType, defaultTooltipEventType = _ref6$defaultTooltipE === void 0 ? "axis" : _ref6$defaultTooltipE, _ref6$validateTooltip = _ref6.validateTooltipEventTypes, validateTooltipEventTypes = _ref6$validateTooltip === void 0 ? ["axis"] : _ref6$validateTooltip, axisComponents = _ref6.axisComponents, legendContent = _ref6.legendContent, formatAxisMap3 = _ref6.formatAxisMap, defaultProps6 = _ref6.defaultProps;
  ...
  var CategoricalChartWrapper = /* @__PURE__ */ function(_Component) {
    function CategoricalChartWrapper2(_props) {
      ...
      _defineProperty42(_this, "handleReceiveSyncEvent", function(cId, data2, emitter) {
      ...
      _defineProperty42(_this, "handleDoubleClick", function(e) {
        ...
        if ((0, import_isFunction18.default)(onDoubleClick)) {
      ...
      _defineProperty42(_this, "handleContextMenu", function(e) {
        ...
        if ((0, import_isFunction18.default)(onContextMenu)) {
          var _nextState6 = _this.getMouseInfo(e);
          onContextMenu(_nextState6, e);
        }
      });
      _defineProperty42(_this, "triggerSyncEvent", function(data2) {
        if (_this.props.syncId !== void 0) {
          eventCenter.emit(SYNC_EVENT, _this.props.syncId, data2, _this.eventEmitterSymbol);
        }
      });
      _defineProperty42(_this, "applySyncEvent", function(data2) {
        ...
        if (data2.dataStartIndex !== void 0 || data2.dataEndIndex !== void 0) {
          ...
          _this.setState(_objectSpread37(_objectSpread37({}, data2), {}, {
            activeLabel,
            activeCoordinate,
            activePayload,
            activeTooltipIndex
      ...
      _defineProperty42(_this, "renderPolarAxis", function(element, displayName, index) {
        ...
        return /* @__PURE__ */ (0, import_react44.cloneElement)(element, _objectSpread37(_objectSpread37({}, axisOption), {}, {
      ...
      _defineProperty42(_this, "renderLegend", function() {
        ...
        return /* @__PURE__ */ (0, import_react44.cloneElement)(item, _objectSpread37(_objectSpread37({}, otherProps), {}, {
          chartWidth: width,
          chartHeight: height,
          margin,
      ...
      _defineProperty42(_this, "renderGraphicChild", function(element, displayName, index) {
        ...
        var graphicalItem = /* @__PURE__ */ (0, import_react44.cloneElement)(element, _objectSpread37(_objectSpread37({}, item.props), itemEvents));
        ...
        if (hasActive) {
          if (activeTooltipIndex >= 0) {
            ...
            if (activeShape || activeBar) {
              ...
              return [/* @__PURE__ */ (0, import_react44.cloneElement)(element, _objectSpread37(_objectSpread37(_objectSpread37({}, item.props), itemEvents), {}, {
                activeIndex
              })), null, null];
            }
      ...
      _defineProperty42(_this, "renderCustomized", function(element, displayName, index) {
        return /* @__PURE__ */ (0, import_react44.cloneElement)(element, _objectSpread37(_objectSpread37({
    ...
    return _createClass20(CategoricalChartWrapper2, [{
      ...
      value: function render() {
        ...
        if (compact) {
          ...
          }, /* @__PURE__ */ import_react44.default.createElement(Surface, _extends29({}, attrs, {
            width,
            height,
            title,
            desc
        ...
        return /* @__PURE__ */ import_react44.default.createElement(ChartLayoutContextProvider, {
          ...
          height: this.props.height,
          clipPathId: this.clipPathId
        }, /* @__PURE__ */ import_react44.default.createElement("div", _extends29({
  ...
  _defineProperty42(CategoricalChartWrapper, "getDerivedStateFromProps", function(nextProps, prevState) {
    ...
    if (dataKey !== prevState.prevDataKey || data2 !== prevState.prevData || width !== prevState.prevWidth || height !== prevState.prevHeight || layout !== prevState.prevLayout || stackOffset !== prevState.prevStackOffset || !shallowEqual(margin, prevState.prevMargin)) {
      ...
      var updatesToState = _objectSpread37(_objectSpread37({}, getTooltipData(prevState, data2, layout)), {}, {
  ...
  var CategoricalChart = /* @__PURE__ */ (0, import_react44.forwardRef)(function CategoricalChart2(props, ref) {
    return /* @__PURE__ */ import_react44.default.createElement(CategoricalChartWrapper, _extends29({}, props, {
      ref
    }));
  });
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=/build/routes/analytics-KEGI7BLA.js.map
