...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\components\\\\shared\\\\ButtonIcon.jsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1733244235049.011";
}
var buttonIconVariants = cva("rounded-full flex items-center justify-center transition-colors duration-200 p-[4px] m-0", {
  variants: {
    size: {
      small: "w-6 h-6",
      medium: "w-8 h-8",
...
var ButtonIcon = _s(import_react.default.forwardRef(_c = _s(({
  className,
  size = "medium",
  iconSize,
  ...
  const iconTheme = isHovered ? colorScheme === "dark" ? "light" : "dark" : colorScheme;
  const iconColorFilter = colorScheme === "dark" ? "invert(1) brightness(0%) contrast(100%)" : "invert(0%) brightness(100%) contrast(100%)";
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Comp, { className: cn(buttonIconVariants({
    size,
    colorScheme,
    className
  })), ref, onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false), ...props, children: typeof iconSrc === "string" ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
    "img",
    {
      src: iconSrc,
      alt,
    ...
    import_react.default.cloneElement(iconSrc, {
      theme: iconTheme,
      width: finalIconSize,
      // Use finalIconSize
      height: finalIconSize
...
ButtonIcon.propTypes = {
  ...
  iconSize: import_prop_types.default.string,
  // Custom size prop for icon width/height
  colorScheme: import_prop_types.default.oneOf(["dark", "light"]),
  iconSrc: import_prop_types.default.oneOfType([import_prop_types.default.string, import_prop_types.default.element]),
  alt: import_prop_types.default.string
};
var _c;
var _c2;
$RefreshReg$(_c, "ButtonIcon$React.forwardRef");
$RefreshReg$(_c2, "ButtonIcon");
...
var ChevronRightIcon = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
    "svg",
    {
      ...
      fill: fill || "none",
      stroke: strokeColor,
      strokeOpacity: strokeOpacity !== void 0 ? strokeOpacity : defaultOpacity,
      strokeLinecap: "round",
...
var chevron_right_default = ChevronRightIcon;
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=/build/_shared/chunk-4BRL4X2O.js.map
